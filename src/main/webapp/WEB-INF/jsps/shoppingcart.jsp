...
<body>
	...
	<section class="section-shopping-cart">
		...
		<div class="row">
			<div class="cart-btns">
				<a href="#" class="cart-btn" id="clear-cart">Clear cart</a> <a
					href="${ contextPath }/menu" class="cart-btn"
					id="continue-shopping">Continue shopping</a>
			</div>
		</div>
	</section>
	...
	<section class="section-comments">
		...
		<form action="#" method="post">
			<div class="row">
				...
				<div id="firstnameError" class="col span-1-of-3 has-error"></div>
			</div>
			...
			<div class="row">
				...
				<div id="lastnameError" class="col span-1-of-3 has-error"></div>
			</div>
			...
			<div class="row">
				...
				<div id="emailError" class="col span-1-of-3 has-error"></div>
			</div>
			...
			<div class="row">
				...
				<div class="col span-1-of-3">
					<input type="tel" pattern='[\(]\d{3}[\)][\-]\d{3}[\-]\d{4}'
						name="phone" id="phone" placeholder="(123)-456-7890" required />
				</div>
				<div id="phoneError" class="col span-1-of-3 has-error"></div>
			</div>
			...
			<div class="row">
				...
				<div class="col span-1-of-3">
					<input type="text" name="address" id="address"
						placeholder="Apt., street" required />
				</div>
				<div id="addressError" class="col span-1-of-3 has-error"></div>
			</div>
